...
inline rclcpp::Clock &lio_clock()  { return *lio_clock_; }
...
template <typename PubCloudT>
void publish_frame_world(PubCloudT pubLaserCloudFull)
{
    if(scan_pub_en)
    {
...
template <typename PubCloudT>
void publish_frame_body(PubCloudT pubLaserCloudFull_body)
{
    int size = feats_undistort->points.size();
...
template <typename PubCloudT>
void publish_effect_world(PubCloudT pubLaserCloudEffect)
{
    PointCloudXYZI::Ptr laserCloudWorld( \
...
template <typename PubCloudT>
void publish_map(PubCloudT pubLaserCloudMap)
{
    PointCloudXYZI::Ptr laserCloudFullRes(dense_pub_en ? feats_undistort : feats_down_body);
    int size = laserCloudFullRes->points.size();
    PointCloudXYZI::Ptr laserCloudWorld( \
...
template <typename PubPathT>
void publish_path(PubPathT pubPath)
{
